import styles from './PDC.module.scss'
    ...
    return (
        <>
            <section className={styles.section}>
                ...
                <div>
                    <p>Le site web levelupquizz.fr est détenu par Xxxxx Yyyyy.</p>
                    <p>
                        ...
                        levelupquizz.fr, qui fournit également les raisons pour lesquelles
                        nous devons collecter certaines données personnelles vous
                        concernant. Par conséquent, vous devez lire cette politique de
                        confidentialité avant d'utiliser le site web de levelupquizz.fr.
                    </p>
                    <p>
                    ...
                    <p>
                        Lorsque vous visitez le levelupquizz.fr, nous recueillons
                    ...
                    <p>
                        ...
                        invités à nous contacter via xxx.xxx@levelupquizz.fr.
                    </p>
                    <h2>Vos droits :</h2>
                    <p>
